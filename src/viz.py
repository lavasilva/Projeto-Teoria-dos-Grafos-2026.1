...
<style>
  * {{ margin:0; padding:0; box-sizing:border-box; }}
  ...
  #painel {{
    ...
    border:1px solid #333; max-height:calc(100vh - 110px);
    overflow-y:auto;
  }}
  ...
  /* ── Safe area para a navegação do vis.js (não pode ficar atrás do #painel) ──
     #painel: left:12px + width:250px = borda direita em 262px.
     Reservamos faixa horizontal a partir de 292px para os botões direcionais. */
  .vis-navigation .vis-button {{ z-index:1 !important; }}
  .vis-navigation .vis-button.vis-left    {{ left:292px !important; }}
  .vis-navigation .vis-button.vis-up,
  .vis-navigation .vis-button.vis-down    {{ left:332px !important; }}
  .vis-navigation .vis-button.vis-right   {{ left:372px !important; }}
